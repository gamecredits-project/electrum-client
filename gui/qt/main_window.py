...
class ElectrumWindow(QMainWindow, PrintError):
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-GMC %s  -  %s' % (self.wallet.electrum_version, self.wallet.basename())
        ...
        if self.wallet.is_watching_only():
            msg = ' '.join([
                ...
                _("This means you will not be able to spend GameCredits with it."),
                _("Make sure you own the seed phrase or the private keys, before you request GameCredits to be sent to this wallet.")
            ])
    ...
    def create_receive_tab(self):
        ...
        msg = _('GameCredits address where the payment should be received. Note that each payment request uses a different Bitcoin address.')
    ...
    def create_send_tab(self):
        ...
        msg = _('Recipient of the funds.') + '\n\n'\
              + _('You may enter a GameCredits address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a Bitcoin address)')
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive gamecredits.") + " " \
